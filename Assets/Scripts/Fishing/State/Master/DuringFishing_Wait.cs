...
namespace Fishing.State
{
    ...
    public class DuringFishing_Wait : MasterStateBase
    {
        ...
        public override void OnEnter()
        {
            ...
            // // 釣り上げ予定の魚
            master.fishToBeCaught = master.GetFishesOfSpecifiedWeight(master.fishSpecies, 1, master.minUserPower * 0.8f, master.minUserPower * 1.2f)[0];
            master.fish = master.fishToBeCaught;
            master.rope.fish = master.fish;
            // // 泳ぎ回る予定の魚
            master.swimmingAroundFishes = master.GetFishesOfSpecifiedWeight(master.fishSpecies, master.numberOfApearanceFishes - 1, master.minUserPower * 0.8f, master.minUserPower * 1.2f);
