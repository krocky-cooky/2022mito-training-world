...
namespace pseudogame.ui
{
    public class headUI : MonoBehaviour
    {
        private Transform target;
        [SerializeField]
        private float followMoveSpeed = 0.1f;
        [SerializeField] 
        private float followRotateSpeed = 0.02f;
        [SerializeField] 
        private float rotateSpeedThreshold = 0.9f;
        [SerializeField] 
        private bool isImmediateMove = false;
        [SerializeField]
        private bool isLockX = false;
        [SerializeField]
        private bool isLockY = false;
        [SerializeField]
        private bool isLockZ = true;
